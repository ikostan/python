...
all_drinks = [
    ...
    (
        "Beet Sumac Soda",
        ["beet", "club soda", "fresh lemon juice", "sugar", "sumac"],
    ),
    (
    ...
    (
        "Bloody Shame",
        ["V8 juice", "black pepper", "celery", "salt", "tabasco sauce"],
    ),
    (
        "Chai Blossom",
        [
    ...
    (
        "Espresso Martini",
        ["coffee liqueur", "espresso", "sugar syrup", "vodka"],
    ),
    (
        "Fermented Grape Soda",
        ["red seedless grapes", "sugar", "washed organic ginger"],
    ),
    ...
    (
        "Margarita",
        ["lime juice", "salt", "simple syrup", "tequila", "triple sec"],
    ),
    (
        "Mojito",
        ["lime", "mint leaves", "soda water", "sugar syrup", "white rum"],
    ),
    ("Moscow Mule", ["ginger beer", "lime", "lime juice", "vodka"]),
    ("Negroni", ["bitters", "gin", "sweet vermouth"]),
    (
        "Old Fashioned",
        ["bitters", "bourbon", "orange juice", "orange slices", "sugar"],
    ),
    (
    ...
    (
        ...
        ["cubed watermelon", "kosher salt", "lime wedges"],
    ),
    (
        "Shirley Tonic",
        [
...
group_2 = [
    (item[1], item[2])
    for item in recipes_without_duplicates
    if item[1] in nondupes
]
